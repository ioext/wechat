...
class WeChatConst
{
    ...
    const SET_INDUSTRY_PARAM_ERROR                  =   CConst::ERROR_USER_START + 13; //刷新access_token失败
    const SET_INDUSTRY_FAIL_ERROR                   =   CConst::ERROR_USER_START + 13; //刷新access_token失败

    const GET_INDUSTRY_INFO_PARAM_ERROR             =   CConst::ERROR_USER_START + 13; //刷新access_token失败
    const GET_INDUSTRY_INFO_FAIL_ERROR              =   CConst::ERROR_USER_START + 13; //刷新access_token失败

    const GET_TEMPLATE_ID_PARAM_ERROR               =   CConst::ERROR_USER_START + 13; //刷新access_token失败
    const GET_TEMPLATE_ID_FAIL_ERROR                =   CConst::ERROR_USER_START + 13; //刷新access_token失败

    const GET_TEMPLATE_LIST_PARAM_ERROR             =   CConst::ERROR_USER_START + 13; //刷新access_token失败
    const GET_TEMPLATE_LIST_FAIL_ERROR              =   CConst::ERROR_USER_START + 13; //刷新access_token失败

    const DEL_TEMPLATE_PARAM_ERROR                  =   CConst::ERROR_USER_START + 13; //刷新access_token失败
    const DEL_TEMPLATE_FAIL_ERROR                   =   CConst::ERROR_USER_START + 13; //刷新access_token失败
